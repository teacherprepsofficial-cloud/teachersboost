  ...
  return (
    <div className="bg-white rounded-[5px] shadow-sm border border-gray-200 p-8 max-w-md w-full">
      ...
      <button
        ...
        disabled={isLoading}
        className="w-full border border-gray-300 py-2 rounded-lg font-semibold hover:bg-gray-50 transition flex items-center justify-center gap-2 disabled:opacity-50"
      >
